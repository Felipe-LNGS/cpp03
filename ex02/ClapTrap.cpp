...
void ClapTrap::info(){
std::cout  <<YELLOW << "🔋 Energy points left : " << _energyPoints << std::endl;
std::cout  <<YELLOW << "❤️  Hit points left : " << _hitPoints << std::endl;
std::cout  <<YELLOW << "⚔️  Attack damage : " << _attackDamage << RESET << std::endl;
